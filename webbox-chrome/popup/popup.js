define(
    ['/web/webbox/util.js','/web/webbox/webbox-model.js','/web/ui/lenses/popup-inbox.js'],
	...
	var PopupView = Backbone.View.extend(
		...
		open_profile:function() {
		    chrome.windows.create({'url': '/web/ui/profile.html', 'type': 'normal'}, function(window) {});
		},
		...
		open_notes:function() {
		    chrome.windows.create({'url': '/web/ui/notes.html', 'type': 'popup'}, function(window) {});
		},
		open_book:function() {
		    chrome.windows.create({'url': '/web/ui/book.html', 'type': 'popup'}, function(window) {});
		}						
	    }
	);
